...
// ContextValidate validates this pod deployment based on context it is used
func (m *PodDeployment) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
