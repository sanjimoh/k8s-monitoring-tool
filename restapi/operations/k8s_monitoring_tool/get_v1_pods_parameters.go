...
// NewGetV1PodsParams creates a new GetV1PodsParams object
// no default values defined in spec.
func NewGetV1PodsParams() GetV1PodsParams {

	return GetV1PodsParams{}
}

// GetV1PodsParams contains all the bound params for the get v1 pods operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetV1Pods
type GetV1PodsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetV1PodsParams() beforehand.
func (o *GetV1PodsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetV1PodsParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
